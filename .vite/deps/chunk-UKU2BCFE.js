...
var FilterService = {
  ...
  filters: {
    ...
    equals: function equals2(value, filter3, filterLocale) {
      ...
      else return ObjectUtils.removeAccents(value.toString()).toLocaleLowerCase(filterLocale) == ObjectUtils.removeAccents(filter3.toString()).toLocaleLowerCase(filterLocale);
    },
...
//# sourceMappingURL=chunk-UKU2BCFE.js.map
